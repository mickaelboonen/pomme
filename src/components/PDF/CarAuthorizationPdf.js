      ...
      <View style={styles.section}>
        ...
        {chosenVehicleType.id === 0 &&  (
          <>
            ...
            <Text style={{ textIndent: 10, fontFamily: 'RadjhaniBold'}}>Numéro de Police : <Text style={{fontFamily: 'Radjhani'}}>{data.police ?? (data.vehicle ? data.vehicle.police : '')}</Text></Text>
          </>
        )}
